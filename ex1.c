...
#include <conio.h>
#include <malloc.h>
// Funcþie care determinã numarul de divizori ai unui intreg
int nr_div (int);
// Funcþie care citeºte de la tastaturã valori pentru elementele unui tablou de intregi
//unidimensional; elementele sunt unice.
void citire(int*, int);
// Funcþie care afiseaza elementele unui tablou de intregi
